...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
       ...
       return fig
        ...
        title=f"Total Success & Failed Counts for {entered_site}")
        return fig 
...
def get_scatter_chart(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
       ...
       title='Scatter Chart showing Correlation between Payload & Success for all Sites')
       return fig
    else:
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color= "Booster Version Category",
        title=f"Scatter Chart schowing Correlation between Payload & Success for {entered_site}")
        return fig 
